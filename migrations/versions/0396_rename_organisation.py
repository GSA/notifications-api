...
def downgrade():
    op.execute('ALTER TABLE services RENAME COLUMN organization_type to organisation_type')
    ...
    op.execute('ALTER TABLE services_history RENAME COLUMN organization_id to organisation_id')
    ...
    op.execute('ALTER TABLE invited_organization_users RENAME to invited_organisation_users')
    op.execute('ALTER TABLE user_to_organisation RENAME COLUMN organization_id to organisation_id')
    op.execute('ALTER TABLE invited_organisation_users RENAME COLUMN organization_id to organisation_id')
    op.execute('ALTER TABLE organization RENAME COLUMN organization_type to organisation_type')
