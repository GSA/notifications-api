...
def downgrade():
    ...
    op.add_column(
        "organisation",
        sa.Column(
            "letter_branding_id", postgresql.UUID(), autoincrement=False, nullable=True
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "letter_branding_id", postgresql.UUID(), autoincrement=False, nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["letter_branding_id"],
            ["letter_branding.id"],
            name="service_letter_branding_letter_branding_id_fkey",
        ),
        sa.ForeignKeyConstraint(
            ["service_id"],
            ["services.id"],
            name="service_letter_branding_service_id_fkey",
        ),
