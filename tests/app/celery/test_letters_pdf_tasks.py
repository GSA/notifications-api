...
def test_process_letter_task_check_virus_scan_passed(
    ...
    mock_get_billable_units_for_pdf = mocker.patch('app.celery.letters_pdf_tasks.get_billable_units_for_pdf', return_value=1)
    ...
    mock_get_billable_units_for_pdf.assert_called_once_with(b'old_pdf')
...
def test_process_letter_task_check_virus_scan_passed_when_sanitise_fails(
    ...
    mock_get_billable_units_for_pdf = mocker.patch('app.celery.letters_pdf_tasks.get_billable_units_for_pdf', return_value=2)
    ...
    mock_get_billable_units_for_pdf.assert_called_once_with(b'pdf_content')
...
def test_process_letter_task_check_virus_scan_passed_when_redaction_fails(
    ...
    mocker.patch('app.celery.letters_pdf_tasks.get_billable_units_for_pdf', return_value=2)
...
def test_process_letter_task_check_virus_scan_passed_when_file_cannot_be_opened(
    ...
    mock_get_billable_units_for_pdf = mocker.patch('app.celery.letters_pdf_tasks.get_billable_units_for_pdf', side_effect=PdfReadError)
...
def test_process_virus_scan_passed_logs_error_and_sets_tech_failure_if_s3_error_uploading_to_live_bucket(
    ...
    mocker.patch('app.celery.letters_pdf_tasks.get_billable_units_for_pdf', return_value=1)
